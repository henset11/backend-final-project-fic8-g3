        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item">Create Khs</div>
                </div>
            </div>
                        ...
                        <div class="card">
                            <form action="{{ route('khs.store') }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label>Nilai</label>
                                        <input type="number" class="form-control @error('nilai') is-invalid @enderror" id="nilai" step="0.01" min="0" max="100" oninput="hitungGrade()" name="nilai">
                                        @error('nilai')
                                    ...
                                    <div class="form-group">
                                        <label>Grade</label>
                                        <input type="text" id="grade" name="grade" class="form-control @error('grade') is-invalid @enderror" readonly>
                                        @error('grade')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
