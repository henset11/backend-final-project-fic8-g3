    ...
    @include('layouts.alert')
                ...
                <div class="row mt-4">
                    ...
                    <a href="{{route('khs.create')}}"
                        class="btn btn-primary">Create Khs</a>
                </div>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table class="table-striped table">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('khs.edit', $row->id) }}" class="btn btn-sm btn-info btn-icon">
                                                    <i class="fas fa-edit"></i>Edit</a>

                                                    <form action="{{ route('khs.destroy', $row->id) }}" method="POST" class="ml-2">
